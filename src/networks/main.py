from .mnist_LeNet import MNIST_LeNet, MNIST_LeNet_Autoencoder, MNIST_Discriminator_L, MNIST_Discriminator_S, MNIST_Generator
from .fmnist_LeNet import FashionMNIST_LeNet, FashionMNIST_LeNet_Autoencoder, FashionMNIST_Discriminator_L, FashionMNIST_Discriminator_S
...
def build_GANs(net_name):
    ...
    if net_name == 'fmnist_LeNet':
        ...
        D_g = FashionMNIST_Discriminator_S()
        G = MNIST_Generator()
    #
    # if net_name == 'cifar10_LeNet':
    #     net = CIFAR10_LeNet(out_dim=num_clt)
    #
    #
    # if net_name == 'arrhythmia_mlp':
    #     net = MLP_Classifier(x_dim=274, h_dims=[128, 64], rep_dim=32,out_dim=num_clt, bias=False)
    #
    # if net_name == 'cardio_mlp':
    ...
    #
    # if net_name == 'thyroid_mlp':
    #     net = MLP_Classifier(x_dim=6, h_dims=[32, 16], rep_dim=4,out_dim=num_clt, bias=False)

    return D_l,D_s, D_g, G
